 ...
 * - Removed the "JOKER" element and all the relevant data
 * - changed the "Points" values of JACK, KING, & QUEEN to be 
 * numerically one greater than its predecessor rather than all 10.
 * This was done for the purposes of being able to differentiate in the
 * Card class's compareTo() method.
 */
...
//  Element     Display Name    Graphic     Points      Alt Points  Priority    Alt Priority
    ...
    JACK    (   "Jack",         "J",        11,         10,         10,         10 ),
    QUEEN   (   "Queen",        "Q",        12,         10,         10,         10 ),
    KING    (   "King",         "K",        13,         10,         10,         10 )
    ;
